...
if __name__ == '__main__':
    # path = '/home/william/Dataset/Data sets/'
    ...
    # # file_name = 'wdbc'
    # # file_name = 'wine'
    # # file_name = 'spectrometer'
    # # file_name = 'glass'
    # # file_name = 'OlivettiFaces'
    # # file_name = 'usps'
    # # file_name = 'mnist'
    ...
    # file_name = 'dim256.txt'

    # file_name = 'cluto-t4.8k.txt'
    # file_name = 'cluto-t7.10k.txt'

    # file_name = 'dense-disk-3000.txt'
    # file_name = 'dense-disk-5000.txt'

    # file_name = 'disk-1000n.txt'
    # file_name = 'disk-3000n.txt'
    # file_name = 'disk-4000n.txt'

    # file_name = 'square3.txt'
    # file_name = 'square4.txt'
    # file_name = 'square5.txt'

    # file_name = 'ds3c3sc6.txt'
    # file_name = 'ds4c2sc8.txt'
    ...
    # file_name = 'banknote.txt'
    # file_name = 'yeast.txt'
    # file_name = 'heart.txt'
    # file_name = 'waveform.txt'
    ...
    # data_embedding, label, cluster_label, pos, node_dict, data_size = read_dataset(path, file_name)

    print(data_embedding.shape)
    assert t <= k < data_embedding.shape[0]
    """聚类"""
    center = clustering(t, k, data_embedding)
    ...
    print('＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊\n\n')
    print('真实类别数：      ', len(unique(label)), '\t', unique(label), '\n预测类别数： ', len(unique([x for x in center if x >= 0])), '\t', unique([x for x in center if x >= 0]))
    print('真实类和成员数量： ', Counter([x for x in label]))
    print('预测类和成员数量： ', Counter([x for x in center if x >= 0]), len(set([i for i in center if i >= 0])))
    print('预测噪音：        ', Counter(noise))

    # plt.scatter(data_embedding[:, 0], data_embedding[:, 1], c=center)
    # plt.show()
